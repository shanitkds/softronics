...
function Inform() {
    ...
    return (
        <div className='h-320 flex'>
            <div>
                <div className='text-center w-140  mt-20 ml-40'>
                    <h1 className='font-medium text-4xl'>OUR STORE</h1>
                    <p className='pt-2 pb-2'>One Of The Best In Malabar</p>
                ...
                <div className="w-140 bg-[#f5f5f5] h-[255px]  ml-40 mt-8">
            ...
            <div>
                <div className='text-center w-140  mt-20 ml-20'>
                    <h1 className='font-medium text-4xl'>SOHWROOM</h1>
                    <p className='pt-2 pb-2'> Visit our showroom in Nellikuth for the best collections</p>
                ...
                <div className='text-center w-140  mt-5 ml-20'>
                    <h1 className='font-medium text-4xl'>QUALITY</h1>
                    <p className='pt-2 pb-2'> Our products are the best quality products</p>
